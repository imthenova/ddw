function ygzBeastPlay(ygz, f, g)
    ...
    local covenant = C_Covenants.GetActiveCovenantID(); --1,Kyrian 2,Venthyr 3,NightFae 4,Necrolord
    ...
    if covenant==2 then cd_echoshot=mwGetCoolDown("劫掠射击"); end
    if covenant==1 then cd_echoshot=mwGetCoolDown("共鸣箭"); end
